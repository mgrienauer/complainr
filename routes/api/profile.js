...
router.get("/handle/:handle", (req, res) => {
	...
	//on the Profile collection/model, find a user with the handle in the request sent to the API
...
router.post(
	...
	(req, res) => {
		...
		//initialize empty social object in profileFields to avoid error
